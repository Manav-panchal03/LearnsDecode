...
// 2. Published Courses
// dashboard.php na top ma aa line update karo
...
// profile check -> complete / incomplete
...
<head>
    ...
    <style>
        ...
        /* --- SIDEBAR & CONTENT (Your existing CSS) --- */
...
<nav id="sidebar">
    ...
    <div class="nav-links">
        ...
        <a href="add_quiz.php"><i class="fas fa-question-circle"></i> Quizzes</a>
...
<div id="content">
    <nav class="navbar navbar-custom d-flex justify-content-between">
        ...
        <!-- <div class="user-info d-flex align-items-center">
            <span class="me-3 text-muted">Welcome, <strong><?php echo $_SESSION['user_name']; ?></strong></span>
            <img src="https://ui-avatars.com/api/?name=<?php echo $_SESSION['user_name']; ?>&background=6c63ff&color=fff" class="rounded-circle shadow-sm" width="40">
        </div> -->
        <div class="user-info d-flex align-items-center">
    ...
    <div class="container-fluid p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <!-- <a href="add_course.php" class="btn btn-primary rounded-pill px-4"><i class="fas fa-plus me-2"></i>New Course</a> -->
        </div>
        ...
        <h4 class="fw-bold mb-4">Your Content</h4>
        <div class="row g-4">
